...
module AssertNoActionBlock(input clk_i, input rst_ni, input eret_o);
  ...
  // CHECK: %[[CLOCK_OP:[0-9]+]] = ltl.clocked_atom %[[PROP]], posedge %[[CLK_I1]] : i1
...
module ConcurrentAssert(input clk);
  // CHECK-DAG: ltl.clocked_atom
  // CHECK-DAG: ltl.clocked_delay
  // CHECK-DAG: ltl.clocked_repeat
  // CHECK-DAG: ltl.clocked_goto_repeat
  // CHECK-DAG: ltl.clocked_non_consecutive_repeat
  // CHECK-DAG: ltl.clocked_until
  // CHECK-DAG: ltl.clocked_eventually
