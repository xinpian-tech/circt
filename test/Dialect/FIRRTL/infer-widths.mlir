...
firrtl.circuit "Foo" {
  ...
  firrtl.module @RegResetSimple(
    ...
    // CHECK: %0 = firrtl.regreset %clk, %rst, %c0_ui1 {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.uint<1>, !firrtl.uint<6>
    // CHECK: %1 = firrtl.regreset %clk, %rst, %c0_ui1 {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.uint<1>, !firrtl.uint<6>
    // CHECK: %2:2 = firrtl.regreset %clk, %rst, %c0_ui17 forceable {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.uint<17>, !firrtl.uint<17>, !firrtl.rwprobe<uint<17>>
    // CHECK: %3 = firrtl.regreset %clk, %rst, %c0_ui17 {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.uint<17>, !firrtl.uint<17>
    %c0_ui = firrtl.constant 0 : !firrtl.uint
    %c0_ui17 = firrtl.constant 0 : !firrtl.uint<17>
    %0 = firrtl.regreset %clk, %rst, %c0_ui {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.uint, !firrtl.uint
    %1 = firrtl.regreset %clk, %rst, %c0_ui {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.uint, !firrtl.uint
    %2:2 = firrtl.regreset %clk, %rst, %c0_ui17 forceable {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.uint<17>, !firrtl.uint, !firrtl.rwprobe<uint>
    %3 = firrtl.regreset %clk, %rst, %c0_ui17 {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.uint<17>, !firrtl.uint
